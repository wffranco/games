...
export interface Location<P extends string = string> extends L<Sector> {
  id: `${P}${string}`;
}
...
interface AncientCipher extends Location<'ac'> {
  name: `Ancient ${'Cipher' | 'Shrine'}${string}`;
  type: 'ancient-cipher' | 'ancient-shrine';
}
...
interface ArtifactFragment extends Location<'af'> {
  name: `Artifact Fragment${string}`;
}
...
export const af = {
  ...
  af08: { id: 'af08', sector: 'the-commons', x: 30.5, y: 69.8, name: 'Artifact Fragment', type: 'artifact-fragment', depends: ['sSlt'] },
...
interface Boss extends Location<'b'> {
  name: `Boss${string}`;
  status: 'important';
}
...
interface Commune extends Location<'c'> { }
...
interface Devotee extends Location<'d'> {
  name: `Devotee${string}`;
}
...
interface DivineRemnant extends Location<'dr'> {
...
export const dr = {
  ...
  dr26: { id: 'dr26', sector: 'the-lost-garden-1', x: 81.6, y: 47.8, name: 'Divine Remnant', type: 'divine-remnant', depends: ['sSlt'] },
  dr27: { id: 'dr27', sector: 'the-lost-garden-1', x: 79.6, y: 47.8, name: 'Divine Remnant', type: 'divine-remnant', depends: ['sDj'] },
...
interface DormantSalt extends Location<'dsr'> {
...
interface Envoy extends Location<'e'> {
  name: `Envoy${string}`;
}
...
export const e = {
  ...
  e03: { id: 'e03', sector: 'the-commons', x: 30.5, y: 67.8, name: 'Envoy', type: 'envoy', depends: ['sDj'] },
...
interface Icor extends Location<'i'> {
  name: `Icor${string}`;
}
...
export const i = {
  ...
  i22: { id: 'i22', sector: 'the-lost-garden-1', x: 81.6, y: 47.8, name: 'Icor', type: 'icor', depends: ['sTp'] },
...
interface JournalEntry extends Location<'je'> {
...
export const je = {
  ...
  je51: { id: 'je51', sector: 'the-old-waters-2', x: 48.5, y: 46.8, name: 'Journal Entry - Monoliths', type: 'journal-entry', depends: ['sLg'] },
} as const satisfies Locations<JournalEntry>;

//---- Minibosses ----//

interface MiniBoss extends Location<'mb'> {
...
export const mb = {
  ...
  mb100: { id: 'mb100', sector: 'the-surface', x: 56.5, y: 39.7, name: 'Miniboss', type: 'miniboss', depends: ['sLg'] },
} as const satisfies Locations<MiniBoss>;

//---- Metal Ingots ----//

interface MetalIngot extends Location<'mi'> {
  name: 'Metal ingot';
  type: 'metal-ingot';
}
...
export const mi = {
  ...
  mi31: { id: 'mi31', sector: 'the-court', x: 21.4, y: 47.8, name: 'Metal ingot', type: 'metal-ingot', depends: ['sTp', 'sH-e', 'sSlt-d'] },
...
interface Monolith extends Location<'mo'> {
  name: `Monolith${string}`;
  type: 'monolith';
}

export const mo = {
  mo51: { id: 'mo51', sector: 'the-old-waters-2', x: 47.5, y: 46.8, name: 'Monolith', type: 'monolith', depends: ['sWc'] },
...
export const o = {
  ...
  oKom: { id: 'oKom', sector: 'the-obsidian-observatory', x: 78.1, y: 25.6, name: 'Reward - Key of Mind', type: 'item', depends: ['', 'qIs-r'] },
} as const satisfies Locations<Location>;

//---- Quests ----//

interface Quest extends Location<'q'> {
  name: `Quest${string}`;
  type: `quest${string}`;
}
...
export const q = {
  ...
  qTga: { id: 'qTga', sector: 'the-shrine', x: 46.5, y: 52.8, name: 'Quest - The Grand Artificer', type: 'quest', depends: ['qCp01-r', 'qCp02-r', 'qCp03-r'], info: ['4 devotees + 1800$', '(300$ + 1500$)'] },
  qCp01: { id: 'qCp01', sector: 'the-commons', x: 29.5, y: 59.8, name: 'Quest - Construct Part #1', type: 'quest', depends: ['sDj', 'qTga-r'] },
  qCp02: { id: 'qCp02', sector: 'the-lost-garden-2', x: 83.6, y: 64.8, name: 'Quest - Construct Part #2', type: 'quest', depends: ['sSlt', 'qTga-r'] },
  qCp03: { id: 'qCp03', sector: 'the-lost-garden-2', x: 63.5, y: 70.8, name: 'Quest - Construct Part #3', type: 'quest', depends: ['qTga-r'] },
...
interface Relic extends Location<'r'> {
  name: `Relic${string}`;
  type: 'relic';
}
...
export const r = {
  ...
  rCl: { id: 'rCl', sector: 'the-lost-garden-1', x: 91.7, y: 55.8, name: 'Relic - Claws of Rahtek', type: 'relic', depends: ['bTc'] },
  ...
  rWh: { id: 'rWh', sector: 'the-lost-garden-1', x: 96.7, y: 47.8, name: 'Relic - Warp Hook', type: 'relic', depends: ['sH'] },
} as const satisfies Locations<Relic>;

//---- Simulacrum (Abilities) ----//

interface Simulacrum extends Location<'s'> {
...
interface Souls extends Location<'so'> {
  name: `Soul${string}`;
  type: 'soul';
}
...
export const so = {
  ...
  so61: { id: 'so61', sector: 'the-repository-of-the-unknown-1', x: 93.6, y: 64.8, name: 'Soul - The Shattered', type: 'soul', depends: ['bTai-r'] },
  ...
  soY07: { id: 'soY07', sector: 'the-court', x: 20.4, y: 63.7, name: 'Soul - The Shattered', type: 'soul', depends: ['oYta-r'], info: '5000$ + 6 Artifact Fragments' },
...
} as const satisfies Locations<Souls>;

//---- Shard of Vitae ----//

interface Shard extends Location<'sv'> {
...
export const sv = {
  ...
  sv16: { id: 'sv16', sector: 'the-abandoned-expedition', x: 71.6, y: 51.8, name: 'Shard of Vitae', type: 'shard-of-vitae', depends: ['sSlt'] },
  sv17: { id: 'sv17', sector: 'the-abandoned-expedition', x: 68.6, y: 45.7, name: 'Shard of Vitae', type: 'shard-of-vitae', depends: ['sSlt'] },
  ...
  sv51: { id: 'sv51', sector: 'the-old-waters-1', x: 39.5, y: 44.7, name: 'Shard of Vitae', type: 'shard-of-vitae', depends: [] },
